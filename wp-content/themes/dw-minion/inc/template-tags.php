...
function dw_minion_entry_meta() {
	...
	if ( ! post_password_required() && comments_open() ) { ?>
		<span class="comments-link">
                    ...
                    <?php echo "&nbsp;"?>
                    <!-- 不显示默认的评论条数
                    <?php comments_popup_link( __( '<i class="icon-comment-alt"></i> 0 Comment', 'dw-minion' ), __( '<i class="icon-comment-alt"></i> 1 Comment', 'dw-minion' ), __( '<i class="icon-comment-alt"></i> % Comments', 'dw-minion' ) ); ?>
                    <?php echo "&nbsp;"?>
                    -->
                    <?php global $user_ID;
